...
const manager = __importStar(require("../index"));
/**
 * Gets environment variables out of Azure Key Vault
 */
const getEnv = (tagType = '', prefix = '') => __awaiter(void 0, void 0, void 0, function* () {
    console.log('Getting ENV params from Azure Key Vault');
    const result = yield manager.listAll(prefix, tagType, '0x');
