...
export { parseKeyVaultSecretIdentifier, logger };
...
export class SecretClient {
    ...
    listPropertiesOfSecretVersionsPage(secretName, continuationState, options = {}) {
        return __asyncGenerator(this, arguments, function* listPropertiesOfSecretVersionsPage_1() {
            if (continuationState.continuationToken == null) {
                ...
                const currentSetResponse = yield __await(withTrace("listPropertiesOfSecretVersions", optionsComplete, (updatedOptions) => this.client.getSecretVersions(this.vaultUrl, secretName, updatedOptions)));
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield __await(withTrace("listPropertiesOfSecretVersions", options, (updatedOptions) => this.client.getSecretVersions(continuationState.continuationToken, secretName, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((bundle) => getSecretFromSecretBundle(bundle).properties));
                }
    ...
    listPropertiesOfSecretsPage(continuationState, options = {}) {
        return __asyncGenerator(this, arguments, function* listPropertiesOfSecretsPage_1() {
            if (continuationState.continuationToken == null) {
                const optionsComplete = Object.assign({ maxresults: continuationState.maxPageSize }, options);
                const currentSetResponse = yield __await(withTrace("listPropertiesOfSecrets", optionsComplete, (updatedOptions) => this.client.getSecrets(this.vaultUrl, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((bundle) => getSecretFromSecretBundle(bundle).properties));
                }
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield __await(withTrace("listPropertiesOfSecrets", options, (updatedOptions) => this.client.getSecrets(continuationState.continuationToken, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((bundle) => getSecretFromSecretBundle(bundle).properties));
                }
    ...
    listDeletedSecretsPage(continuationState, options = {}) {
        return __asyncGenerator(this, arguments, function* listDeletedSecretsPage_1() {
            if (continuationState.continuationToken == null) {
                const optionsComplete = Object.assign({ maxresults: continuationState.maxPageSize }, options);
                const currentSetResponse = yield __await(withTrace("listDeletedSecrets", optionsComplete, (updatedOptions) => this.client.getDeletedSecrets(this.vaultUrl, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
            ...
            while (continuationState.continuationToken) {
                const currentSetResponse = yield __await(withTrace("lisDeletedSecrets", options, (updatedOptions) => this.client.getDeletedSecrets(continuationState.continuationToken, updatedOptions)));
                continuationState.continuationToken = currentSetResponse.nextLink;
                if (currentSetResponse.value) {
                    yield yield __await(currentSetResponse.value.map((bundle) => getSecretFromSecretBundle(bundle)));
                }
